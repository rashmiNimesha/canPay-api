...
public class AuthController {
        ...
        public ResponseEntity<?> createProfile(
                ...
                if (email == null || name == null || nic == null) {
                        logger.warn("Missing required fields in create-profile request: email={}, name={}, nic={}",
                                        email, name,
                                        nic);
                        return new ResponseEntityBuilder.Builder<Map<String, Object>>()
                                        .resultMessage("Missing required fields")
                ...
                try {
                        ...
                        switch (role) {
                                case PASSENGER:
                                        ...
                                        try {
                                                ...
                                                logger.warn("Invalid account number for PASSENGER profile: {}",
                                                                accNoStrP);
                                                return new ResponseEntityBuilder.Builder<Map<String, Object>>()
                                        ...
                                        user = userServiceImpl.updatePassengerProfile(email, name, nic, accNameP, bankP,
                                                        accNoP, role);
                                        if (user == null) {
                                                logger.error("updateProfileWithBankAccount returned null for email: {} and role: {}",
                                                                email,
                                                                role);
                                                return new ResponseEntityBuilder.Builder<Map<String, Object>>()
                                ...
                                case OPERATOR:
                                        ...
                                        user = userServiceImpl.updateOperatorProfile(email, name, nic, profileImageOp,
                                                        role);
                                        if (user == null) {
                                                logger.error("updateOperatorProfile returned null for email: {} and role: {}",
                                                                email, role);
                                                return new ResponseEntityBuilder.Builder<Map<String, Object>>()
                                                                .resultMessage("Failed to update profile: User not found or invalid data")
                                                                .httpStatus(HttpStatus.NOT_FOUND)
                                ...
                                case OWNER:
                                        ...
                                        if (profileImageOw == null || accNoStrOw == null || bankOw == null
                                                        || accNameOw == null) {
                                        ...
                                        user = userServiceImpl.updateOwnerProfile(email, name, nic, profileImageOw,
                                                        accNameOw, bankOw,
                                                        accNoOw, role);
                                        if (user == null) {
                                                logger.error("updateOwnerProfile returned null for email: {} and role: {}",
                                                                email, role);
                                                return new ResponseEntityBuilder.Builder<Map<String, Object>>()
                                                                .resultMessage("Failed to update profile: User not found or invalid data")
                                                                .httpStatus(HttpStatus.NOT_FOUND)
                        ...
                        logger.error("Failed to update profile for email: {} and role: {}. Reason: {}", email, role,
                                        e.getMessage(),
                                        e);
                        return new ResponseEntityBuilder.Builder<Map<String, Object>>()
                                        .resultMessage(
        ...
        public ResponseEntity<?> checkUser(@RequestBody Map<String, String> request) {
                ...
                logger.info("Check user completed for email: {} and role: {}. Exists: {}, CanRegisterNewRole: {}",
                                email, role,
        ...
        public ResponseEntity<?> validateToken(@RequestHeader(value = "Authorization") String authHeader) {
                ...
                try {
                        ...
                        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                                        .body(Map.of("success", false, "message", "Invalid or expired token", "action",
                                                        "otp"));
                }
        }
